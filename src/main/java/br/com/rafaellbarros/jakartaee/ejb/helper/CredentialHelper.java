...
public class CredentialHelper {
    ...
    private CredentialHelper(PasswordGeneratorBuilder builder) {
    ...
    public static String enforce(String p, String secret) {
        try {
            String message = p;
            ...
            System.out.println("password enforce error");
        }
        throw new IllegalArgumentException("password enforce error");
    }
    ...
    public static class PasswordGeneratorBuilder {
        ...
        public CredentialHelper build() {
            return new CredentialHelper(this);
        }
    }
